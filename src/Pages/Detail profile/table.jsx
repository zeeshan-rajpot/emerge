...
const Tablee = () => {
    ...
    return (
        <>
            <Container>
                <Row>
                    <Col xs={12} md={4} className='shadow m-auto bg-deaitl rounded-4 mobw100' style={{ minHeight: '200px', width: '30%' }}>
                        <div className='text-center pt-2'>
                            <img src="/de4zci5-070477c6-12e0-4d32-80db-8592ff266c4d.png" alt="" width='100px' className=' p-1 m-auto' style={{ border: '#C54FE8 dashed 1px', borderRadius: '50%' }} />
                        </div>
                        <div className='text-center mt-2'>
                            <p className='mb-0' style={{ fontSize: '12px' }}><b> Anas Shiek </b></p>
                        </div>

                        <div className='text-center'>
                            <p className='text-secondary mb-0' style={{ fontSize: '12px' }}>Lorem ipsum dolor sit  </p>
                        </div>

                        <div className='d-flex align-items-center justify-content-around mt-3'>
                            <div className='text-center'>
                                <p className='mb-0' style={{ fontSize: '12px' }}>54,214 </p>
                    ...
                    <Col md={4} className='shadow m-auto rounded-4 mobw100' style={{ minHeight: '220px', width: '30%' }}>
                        <div className=' mt-3 d-flex align-items-center' style={{ justifyContent: 'space-between' }}>

                            <p className='mb-0' style={{ fontSize: '13px' }}>Shamsi Ali Followers</p>
                            <p className='mb-0' style={{ fontSize: '13px', color: '#C54FE8' }}>See All</p>
                        </div>
                        <div className=' mt-3 d-flex align-items-center justify-content-start border-bottom pb-1'>
                            ...
                            <div className='ms-2 border-bottom-1'>
                                ...
                                <p className='mb-0 text-secondary' style={{ fontSize: '10px' }}>Sheik Bari wadi Film ay</p>
                            </div>
                        </div>
                        <div className=' mt-3 d-flex align-items-center justify-content-start border-bottom pb-1'>
                            <div>
