  ...
  return (
    <>
      <Link to="/DetailPageFeedback">
        <div
          className="d-flex align-items-center justify-content-start border rounded-5 overflow-hidden mt-4 bg-white"
          style={{}}
        >
        ...
        <Row>
          ...
          >
            ...
            <Row>
              <Col
                md={12}
                className="p-4 bg-white m-auto rounded-5 mt-4"
                style={{
                  background: "#F9F9F9",
                  width: "97%",
              ...
              >
                ...
                <input
                  type="text"
                  className="w-100 p-2 py-3 border rounded-4 "
                  placeholder="Anas Akhtar"
                />
                ...
                <textarea
                  ...
                  cols="20"
                  rows="5"
                  className="w-100 rounded-5 border p-3"
                  placeholder="Anyway, I'm pretty sure I'm just imagining things, but it made me think of you! How's everything going on your end? Let's catch up soon!"
                ></textarea>
                <div className="text-center mt-5">
                  <button
                    className="px-5 rounded-5  pribg text-light border-0 py-2 m-auto text-center"
                    style={{ width: "300px" }}
                  >
                    Send
                  </button>
