                        ...
                        <div className="table-responsive">
                            <Table>
                                <thead className='pribg'>
                                    <tr className='pribg'>
                                        {['Sr.', 'Chat Creator Name', `Profile I'D`, 'Account Type', 'Chat Member', `Chat Member Name`, 'Chat Charges', 'Session Date/Time', `Duration Time`, 'Action'].map((header, index) => (
                                    ...
                                    {data.map((row, index) => (
                                        <tr key={index} style={{}}>
                                            ...
                                            <td style={{ fontSize: '13px' }}>
                                                <img src='/25e8ab5f311118b4be3c54e05bf44108.png' alt="Example" width="20" height="20" className='me-2' />
                                            ...
                                            <td style={{ fontSize: '13px' }}>{row.SessionDateTime}

                                            </td>

                                            <td style={{ fontSize: '13px' }}>{row.DurationTime}
                                            </td>
                                            <td style={{ fontSize: '13px' }}>Edit
                                            </td>
