...
const Chattab = () => {
  ...
  return (
    <>
      <div
<<<<<<< HEAD
        className=' d-flex justify-content-center align-items-center shadow m-auto w-50 '
=======
        className='mt-4 d-flex justify-content-center align-items-center shadow m-auto w-50 '
