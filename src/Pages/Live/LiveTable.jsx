...
const LiveTable = () => {
    const dataArray = [
      ...
      const Livelist = [
        { id: 1, profileName: 'John Doe', profileID: '12345', Invite: 'john.doe@example.com', AccountType: 'USA', zipCode: '12345', Likes: 1000, Comment: 500, Shares: 50, Price: '2022-03-10', Tipping: 'edit', SessionDateTime: '2022-06-01 10:00 AM', DurationTime: '1 hour', TittleLink: 'https://example.com' },
        { id: 2, profileName: 'Jane Smith', profileID: '67890', Invite: 'jane.smith@example.com', AccountType: 'UK', zipCode: '54321', Likes: 1500, Comment: 700, Shares: 80, Price: '2022-04-15', Tipping: 'edit', SessionDateTime: '2022-06-02 11:00 AM', DurationTime: '45 minutes', TittleLink: 'https://example.com' },
        { id: 1, profileName: 'John Doe', profileID: '12345', Invite: 'john.doe@example.com', AccountType: 'USA', zipCode: '12345', Likes: 1000, Comment: 500, Shares: 50, Price: '2022-03-10', Tipping: 'edit', SessionDateTime: '2022-06-01 10:00 AM', DurationTime: '1 hour', TittleLink: 'https://example.com' },
        { id: 2, profileName: 'Jane Smith', profileID: '67890', Invite: 'jane.smith@example.com', AccountType: 'UK', zipCode: '54321', Likes: 1500, Comment: 700, Shares: 80, Price: '2022-04-15', Tipping: 'edit', SessionDateTime: '2022-06-02 11:00 AM', DurationTime: '45 minutes', TittleLink: 'https://example.com' },
        { id: 1, profileName: 'John Doe', profileID: '12345', Invite: 'john.doe@example.com', AccountType: 'USA', zipCode: '12345', Likes: 1000, Comment: 500, Shares: 50, Price: '2022-03-10', Tipping: 'edit', SessionDateTime: '2022-06-01 10:00 AM', DurationTime: '1 hour', TittleLink: 'https://example.com' },
        { id: 2, profileName: 'Jane Smith', profileID: '67890', Invite: 'jane.smith@example.com', AccountType: 'UK', zipCode: '54321', Likes: 1500, Comment: 700, Shares: 80, Price: '2022-04-15', Tipping: 'edit', SessionDateTime: '2022-06-02 11:00 AM', DurationTime: '45 minutes', TittleLink: 'https://example.com' },
      ...
      <div className="table-responsive">
                            <Table>
                                <thead className='pribg'>
                                    <tr className='pribg'>
                                        {['Sr.', 'Profile Name', `Profile I'D`, 'Invite', 'Account Type', `Zip Code`, 'Likes', 'Comment', `Shares`, 'Price', 'Tipping','Session Date/Time','Duration Time' ,'Tittle/Link'].map((header, index) => (
